...
--
-- Client :  localhost
-- Généré le :  Mer 26 Avril 2023 à 21:33
...
(27, 'images/userPdp/1682544274276004.jpg', 'elonDusk', '@elonDusk', '$2y$10$YlXa9APgJltWf4CkOeu96OdyrTHcuOyZM.edHdql02l8osWrYJex2'),
...
(32, 'images/userPdp/1682544218324765.jpg', 'elonGusk', '@elonGusk', '$2y$10$K4gVbtbGR0TN.X5av3zQTemlIMtWR.eOkYCU16iflcFbdnnNz10Ka');
...
(117, 'MAIS CE SITE EST --r[INCROYABLE]r-- !', 4, 2, 25, 1682435079, 'images/userImages/1682435112259540.png', 1),
(118, 'J\'aime beaucoup les #lasagnes', 1, 0, 25, 1682435144, '', NULL),
(120, 'Je suis Elon Dusk et j\'approuve l\'utilisateur @elonPusk', 2, 1, 27, 1682435669, '', NULL),
(121, 'Je suis Elon Pusk et j\'approuve ce site \r\n\r\n-///EnvoyÃ© depuis ma fusÃ©e///', 3, 1, 26, 1682435859, '', 1),
...
(133, 'J\'aime la libertÃ© d\'expression et les #lasagnes', 0, 0, 32, 1682543629, '', NULL),
(134, 'Ok, time to get funky join my #twitch [here](https://www.twitch.tv/)', 1, 0, 26, 1682544572, 'images/userImages/1682544721266422.png', 1);
...
--
ALTER TABLE `post_reposts`
  MODIFY `repost_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
--
...
--
ALTER TABLE `trends`
  MODIFY `trend_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
--
